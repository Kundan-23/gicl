...
export const adminAPI = {
  ...
  uploadIdCardSignature:(file)        => { const f = new FormData(); f.append('file', file); return API.post('/admin/config/id-card-signature/upload', f, { headers: { 'Content-Type': 'multipart/form-data' } }); },
