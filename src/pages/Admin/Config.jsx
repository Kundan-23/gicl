            ...
            {plans.map((plan, pi) => (
              <div key={plan.id || pi} style={{ backgroundColor: 'rgba(0,0,0,0.15)', borderRadius: 'var(--radius-lg)', padding: '1.25rem', border: '1px solid var(--border-subtle)', position: 'relative' }}>
                ...
                <div style={{ marginBottom: '1rem' }}>
                  ...
                  <button onClick={() => addPlanFaq(pi)} style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', padding: '0.5rem 1rem', borderRadius: 'var(--radius-md)', background: 'rgba(249,203,26,0.1)', color: 'var(--brand-primary)', border: '1px solid rgba(249,203,26,0.2)', fontWeight: 600, cursor: 'pointer', fontSize: '0.8rem', width: 'max-content' }}>
